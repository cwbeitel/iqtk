...
Workflows build and deployed with the Inquiry Toolkit don't actually require that you install anything! So if you're a "regular" user (not a developer) you can run workflows generated by IQTK right from the DataFlow Template interface. Here are a few tutorials to get you started!
